...
* Java SE provider and Version tested with:  OpenJDK Runtime Environment (Red_Hat-21.0.2.0.13-2) (build 21.0.2+13)
...
* Public URL of TCK Results Summary: link:tck-results/jdk-21.txt[RESTEasy 7.0.0.Alpha1 TCK results]
