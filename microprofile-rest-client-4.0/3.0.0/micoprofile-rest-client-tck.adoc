...
** https://oss.sonatype.org/content/repositories/orgeclipsemicroprofile-1702/org/eclipse/microprofile/rest/client/microprofile-rest-client-api/4.0/microprofile-rest-client-api-4.0.jar[MicroProfile REST Client TCK 4.0.0],
