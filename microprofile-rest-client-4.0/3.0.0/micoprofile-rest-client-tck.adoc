...
** https://download.eclipse.org/microprofile/microprofile-rest-client-4.0/microprofile-rest-client-spec-4.0.html[Eclipse MicroProfile REST Client 4.0]
** https://download.eclipse.org/microprofile/microprofile-rest-client-4.0/[Download]

* TCK Version, digital SHA-256 fingerprint and download URL:
** https://www.eclipse.org/downloads/download.php?file=/microprofile/microprofile-rest-client-4.0-RC1/microprofile-rest-client-tck-4.0.jar[MicroProfile REST Client TCK 4.0.0],
